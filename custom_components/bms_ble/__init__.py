...
from .dx_bms import custom_bms_module
...
async def async_migrate_entry(
    ...
    if entry_version.major < 2:
        bms_module = new_data["type"].rsplit(".", 1)[-1]
        new_data["type"] = custom_bms_module(f"aiobmsble.bms.{bms_module}")
    ...
    new_data["type"] = custom_bms_module(new_data["type"])
